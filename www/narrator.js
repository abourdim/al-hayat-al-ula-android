/* ═══════════════════════════════════════════════════════════
   NARRATOR.JS — Audiobook narrator for Al-Hayat Al-Ula
...
(function() {
  ...
  function onSpeedChange(val) {
    ...
    localStorage.setItem('hayat-narrator-speed', STATE.speed);
  }
  ...
  function onPitchChange(val) {
    ...
    localStorage.setItem('hayat-narrator-pitch', STATE.pitch);
  }
  ...
  function onKaraokeToggle(checked) {
    ...
    localStorage.setItem('hayat-narrator-karaoke', checked);
  }

  function onAutoScrollToggle(checked) {
    STATE.autoScroll = checked;
    localStorage.setItem('hayat-narrator-autoscroll', checked);
  }

  function onDuoToggle(checked) {
    STATE.duoReading = checked;
    localStorage.setItem('hayat-narrator-duo', checked);
  }
  ...
  function loadSettings() {
    STATE.speed = parseFloat(localStorage.getItem('hayat-narrator-speed')) || 1;
    STATE.pitch = parseFloat(localStorage.getItem('hayat-narrator-pitch')) || 1;
    STATE.karaokeEnabled = localStorage.getItem('hayat-narrator-karaoke') !== 'false';
    STATE.autoScroll = localStorage.getItem('hayat-narrator-autoscroll') !== 'false';
    STATE.duoReading = localStorage.getItem('hayat-narrator-duo') === 'true';
  }
