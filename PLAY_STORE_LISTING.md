# Play Store listing — Al Hayat al-Ula (الحياة الأولى)
...
- **Package name**: `org.workshopdiy.alhayatalula`
...
```
كتاب "الحياة الأولى" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
🌅 الحياة الأولى — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "الحياة الأولى" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "الحياة الأولى" — الشيخ محمد الغزالي
...
### App name
```
Al Hayat al-Ula — The First Life
```

### Short description
```
"The First Life" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "The First Life" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "The First Life" — Sheikh Mohammed al-Ghazali
...
### App name
```
Al Hayat al-Ula — Al Hayat al-Ula
```

### Short description
```
« The First Life » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « The First Life » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « The First Life » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Al Hayat al-Ula
Last updated: 2026-04-26

The Al Hayat al-Ula app does not collect, store, transmit, or share any personal
